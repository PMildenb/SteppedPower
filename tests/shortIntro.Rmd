...
## 4 Clusters
```{r}
wlsMixed_4swd <- wlsMixedPower(EffSize=2, sigma=1, tau=0.1, 
                                N=1, Cl=c(1,1,1,1), design="SWD")
plot_wlsPower(wlsMixed_4swd)[[1]]
wlsMixed_4swd$Power


wlsMixed_4parll <- wlsMixedPower(EffSize=2, sigma=1, tau=0.1, 
...
number of clusters and periods
```{r}
compare_designs(EffSize=1, sigma=1 ,tau=.1, Cl=c(1,1,1,1))
compare_designs(EffSize=2, sigma=1 ,tau= 1, Cl=c(1,1,1,1))
```
...
current state of the package    `devtools::install.github()`
