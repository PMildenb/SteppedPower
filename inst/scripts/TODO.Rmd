...
* make input options more flexible, i.e. x different, user-defined `DesMat`s to compare.

## wlsMixedPower

* options to adjust for degrees of freedom (between-within, containment, none, ... ) **DONE**
...
## construct_CovMat
  ...
  * other options for time_adjust: "linear", "periodic", **DONE**
