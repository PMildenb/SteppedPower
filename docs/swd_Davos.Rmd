...
in dem Fall ist tau unter Kontrolle und unter Intervention gleich.
...
```{r}
error <- as.data.frame(mapply(realpower.simulate,1:1000,
                MoreArgs=list(nInd=38,mu0=0.33,mu1=.33,tau=.0,design=swDsn(c(3,4,3)),whichModel=c("AGQ","PQL"))))
