...
* `SteppedPower` calculates power for longitudinal interventional studies
* offers tools for visualization
...
* offers convenient option to compare power of different designs 
...
compare_designs(EffSize=0.01,sigma=1,tau=.15,Cl=rep(2,50),N=250)
```
...
attr <- c("add a attrition over time",0.8,2.1)
