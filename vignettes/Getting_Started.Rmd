...
longitudinal studies are random effects.[@hussey2007design]
...
once with high autocorrelation (`tauAR=0.9`):

```{r}
a <- wlsPower(Cl=c(2,2,2,2), mu0=0, mu1=1, 
              sigma=1, N=100, tau=1, tauAR=.6, verbose=2)

b <- wlsPower(Cl=c(2,2,2,2), mu0=0, mu1=1, 
              sigma=1, N=100, tau=1, tauAR=.9, verbose=2)
plot(a)
plot(b)
```
...
In a closed cohort the patients are observed over the whole study period or 
