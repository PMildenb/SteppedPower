...
`SteppedPower` can also handle binomial and count (Poisson) outcomes, both with an identity link (see the [Binomial Outcomes](Binomial_Outcomes.html) vignette for the binomial case).
